...
> [!NOTE]
> **关于燕子 1.0.0 正式版与 VIP 维护计划的说明**
> - **1.0.0 正式版发布**：燕子正式迈入 1.0.0 阶段，提供更强的性能、全新的 VIP 维护计划以及跨端体验。
> - **维护期永续许可（类 JetBrains 模式，买得安心）**：
>   - 用户购买 VIP（月卡、年卡、终身）享有对应时长的“更新维护期”；
>   - **永久回退与保留**：在您的 VIP 维护期内发布的所有版本（包括 1.0.0 及到期前的更新），您均拥有**永久使用权**，到期后绝不会强制锁死或影响现有版本使用；
>   - **版本升级机制**：VIP 维护期到期后，后续发布的更高版本将无法直接升级使用。当您需要体验后续新功能时，随时续费激活即可立即解锁最新版！
> - **开源与历史版本保障**：0.3.x 及之前的核心基础功能永久保留，本地快捷启动、鼠标面板、本地搜索等绝不设卡。
>
> 🛒 **VIP 赞助维护与自动发卡店铺**：[https://wzyp.cn/shop/4AOUCE2B](https://wzyp.cn/shop/4AOUCE2B)  
